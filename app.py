...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/advin2321/Cvue' target='_blank' style='text-decoration: none;'>
    ...
    def render_dashboard(self):
        ...
        st.toast("Check out these repositories: [Resume analytics](https://github.com/advin2321/Cvue)", icon="ℹ️")
    ...
    current_name.replace(
        ...
        st.toast("Check out these repositories: [resume analyze](https://github.com/advin2321/Cvue)", icon="ℹ️")
    ...
    "assets",
     "124852522.jpeg")
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else 'https://avatars.githubusercontent.com/Hunterdii'}"
                     alt="Sarthak Kumar"
                     class="profile-image"
                     onerror="this.onerror=null; this.src='https://avatars.githubusercontent.com/advin2321';">
                <h2 class="profile-name">Sarthak Kumar (advin2321)</h2>
                <p class="profile-title">Full Stack Developer & AI/ML Enthusiast</p>
                <div class="social-links">
                    <a href="https://github.com/advin2321/Cvue" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://github.com/advin2321/Cvue" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:sarthakkumar22032005@gmail.com" class="social-link" target="_blank">
        ...
        st.toast("Check out these repositories: [check it](https://github.com/advin2321/Cvue)", icon="ℹ️")
    ...
    "Upload your resume", type=[
        ...
        st.toast("Check out these repositories: [check out](https://github.com/advin2321/Cvue)", icon="ℹ️")
...
<div style="background-color: #1e1e1e; border-radius: 10px; border: 1px solid #4b6cb7; padding: 10px; margin: 10px 0; color: white;">
    ...
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/advin2321/Cvue" target="_blank" style="color: #4CAF50;">Check out</a></li>
        <li><a href="https://github.com/advin2321/Cvue" target="_blank" style="color: #4CAF50;">Check out</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>Programming Languages:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/advin2321/Cvue" target="_blank" style="color: #4CAF50;">check out</a></li>
        <li><a href="https://github.com/advin2321/Cvue" target="_blank" style="color: #4CAF50;">30 check out</a></li>
    </ul>
